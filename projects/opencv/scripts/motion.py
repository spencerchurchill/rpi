...
mail.ehlo()
mail.starttls()
mail.login('spencer.l.churchill@gmail.com','Mustelid1')
#content = 'Intruder Alert!'
msg['Subject'] = "Intruder Near House!"
body = """Connect to video stream at 99.90.73.0:5901
or connect to 99.90.73.0:80 (on internet) and login to vnc.

If you're at home then type pineapple into the webbrowser and proceed to vnc.
...
BLUR_SIZE = 10
MIN_AREA = 10       # excludes all contours less than or equal to this Area
    ...
    for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        if first_image:
            ...
            if motion_found:
                ...
                text = msg.as_string()
                mail.sendmail('spencer.l.churchill@gmail.com','spencer.l.churchill@gmail.com',text)
                if window_on:
